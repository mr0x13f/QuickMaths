...
public partial struct mat4 {
    ...
    public static mat4 fromPerspective(float fovy, float ratio, float znear, float zfar) {
        ...
        float t = Math.tan(fovy/180*Math.PI/2);
    ...
    public static explicit operator mat4(float[] m) {
        return new mat4(
            m[0], m[1], m[2], m[3],
            m[4], m[5], m[6], m[7],
            m[8], m[9], m[10], m[11],
    ...
    public static explicit operator float[](mat4 m) {
        return new float[] {
    ...
    public static mat4 operator*(vec4 a, mat4 b) => b * a;
    ...
    public static mat4 operator*(float a, mat4 b) => b * a;
